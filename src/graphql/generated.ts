...
export type GetLassonBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLassonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLassonBySlugDocument = gql`
    query GetLassonBySlug($slug: String) {
...
/**
 * __useGetLassonBySlugQuery__
 *
 * To run a query within a React component, call `useGetLassonBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLassonBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLassonBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLassonBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLassonBySlugQuery, GetLassonBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLassonBySlugQuery, GetLassonBySlugQueryVariables>(GetLassonBySlugDocument, options);
      }
export function useGetLassonBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLassonBySlugQuery, GetLassonBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLassonBySlugQuery, GetLassonBySlugQueryVariables>(GetLassonBySlugDocument, options);
        }
export type GetLassonBySlugQueryHookResult = ReturnType<typeof useGetLassonBySlugQuery>;
export type GetLassonBySlugLazyQueryHookResult = ReturnType<typeof useGetLassonBySlugLazyQuery>;
export type GetLassonBySlugQueryResult = Apollo.QueryResult<GetLassonBySlugQuery, GetLassonBySlugQueryVariables>;
