...
import { useGetLassonBySlugQuery } from "../graphql/generated";
...
export function Video(props: VideoProps) {
  ...
  const { data } = useGetLassonBySlugQuery({
    variables: {
    ...
    return(
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                ...
                <div className="gap-4 mt-20 grid grid-cols-2">
                    ...
                    <a className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors" href="">
                        ...
                        <div className="py-6 leading-relaxed">
                            ...
                            <p className="text-sm text-gray-200 mt-2">
                                Baix wallpapers exclusivos do Ignite Lab e personalize a sua máquina
                            </p>
                        </div>
                        <div className="h-full p-6 flex items-center">
                            <CaretRight size={24} />
